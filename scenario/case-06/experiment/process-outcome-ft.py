...
# Read the CSV file
df = pd.read_csv('/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-06/data/450-train-llm.csv')
...
df.to_csv('/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-06/data/450-train-llm-process.csv', index=False)
