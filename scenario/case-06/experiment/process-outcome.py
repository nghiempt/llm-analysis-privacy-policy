...
# Read the CSV file
df = pd.read_csv('/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-06/data/150-test-ft.csv')
...
df.to_csv('/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-06/data/150-test-ft-process.csv', index=False)
