    ...
    def ask_gpt(data_safety_content, privacy_policy_content):
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                model=os.getenv("MODEL_GPT_4.0"), messages=prompt_message
            )
...
async def main():
    ...
    input_csv_path = "/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-06/data/450-train-need.csv"
    output_csv_path = "/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-06/data/450-train-llm.csv"
