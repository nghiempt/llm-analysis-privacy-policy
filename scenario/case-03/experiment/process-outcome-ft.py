...
# Read the CSV file
df = pd.read_csv('/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-03/data/150-train-llm.csv')
...
df.to_csv('/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-03/data/150-train-llm-process.csv', index=False)
