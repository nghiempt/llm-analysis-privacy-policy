...
class HANDLER:
    ...
    def ask_gpt(data_safety_content, privacy_policy_content):
        ...
        return response.json()['candidates'][0]['content']['parts'][0]['text'] if response.status_code == 200 else "Error"
...
async def main():
    ...
    input_csv_path = "/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-05/data/150-train-llm-still-error.csv"
    output_csv_path = "/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-05/data/150-train-llm-still-error-fix.csv"
