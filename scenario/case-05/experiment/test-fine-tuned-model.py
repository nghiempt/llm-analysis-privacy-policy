    ...
    def ask_gpt(data_safety_content, privacy_policy_content):
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                model=os.getenv("GPT3_5FT_BY_GEMINI_LABEL_150"), messages=prompt_message
            )
...
async def main():
    ...
    input_csv_path = "scenario/case-05/data/150-test-none.csv"
    output_csv_path = "scenario/case-05/data/150-test-ft.csv"
