    ...
    def ask_gpt(data_safety_content, privacy_policy_content):
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                model=os.getenv("case_04"), messages=prompt_message
            )
...
async def main():
    ...
    input_csv_path = "/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-04/data/150-test-none.csv"
    output_csv_path = "/Users/nghiempt/Src/Research/conf_a&p_2025/scenario/case-04/data/150-test-ft.csv"
